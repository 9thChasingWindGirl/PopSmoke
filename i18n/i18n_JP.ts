...
export const i18n_JP = {
  ...
  // ============ Supabase Guide ============
  howToGetSupabaseApi: 'Supabase API 認証情報を取得方法は？',
  supabaseGuideTitle: 'Supabase セットアップガイド',
  whatIsSupabase: 'Supabase とは？',
  supabaseDescription: 'Supabase は、PostgreSQL データベース、認証、リアルタイムサブスクリプションなどを提供するオープンソースの Firebase 代替です。',
  supabaseUseCase: 'Supabase を使用すると、吸烟記録を複数のデバイスで同期し、クラウドに安全にバックアップできます。',
  supabaseRequirements: '必要なもの：',
  supabaseEmail: 'Supabase アカウント登録用のメールアドレス',
  supabaseTime: '設定完了まで約5〜10分',
  supabaseStep1: 'ステップ1：Supabase アカウントを登録',
  supabaseStep1Desc1: 'Supabase ウェブサイトにアクセス：',
  supabaseStep1Desc2: '右上の "Start your project" または "Sign In" をクリック',
  supabaseStep1Desc3: 'GitHub アカウントまたはメールで登録/ログイン',
  supabaseTip: '💡 ヒント：Supabase は個人使用には十分な無料プランを提供しています。',
  supabaseStep2: 'ステップ2：新プロジェクトを作成',
  supabaseStep2Desc1: 'ログイン後、"New project" ボタンをクリック',
  supabaseStep2Desc2: '組織を選択または作成',
  supabaseStep2Desc3: 'プロジェクト情報を入力：',
  supabaseStep2Desc4: 'Name：プロジェクト名（例：popsmoke-tracker）',
  supabaseStep2Desc5: 'Database Password：データベースパスワードを設定（覚えておいてください）',
  supabaseStep2Desc6: 'Region：最も近いサーバーリージョンを選択',
  supabaseStep2Desc7: '"Create new project" をクリックしてプロジェクトを作成',
  supabaseNote: '⏳ 注意：プロジェクトの作成には1〜2分かかりますので、お待ちください。',
  supabaseStep3: 'ステップ3：API 認証情報を取得',
  supabaseStep3Desc1: 'プロジェクト作成後、プロジェクトダッシュボードに入る',
  supabaseStep3Desc2: '左メニューの "Project Settings" をクリック',
  supabaseStep3Desc3: '"API" タブを選択',
  supabaseStep3Desc4: '"Project API keys" セクションで以下の情報を確認：',
  supabaseProjectUrl: 'Project URL：',
  supabaseAnonKey: 'anon public：',
  supabaseStep4: 'ステップ4：このアプリに設定',
  supabaseStep4Desc1: 'このアプリの <strong>SUPABASE_URL</strong> フィールドに "Project URL" をコピー',
  supabaseStep4Desc2: 'このアプリの <strong>SUPABASE_ANON_KEY</strong> フィールドに "anon public" キーをコピー',
  supabaseStep4Desc3: '保存ボタンをクリックして設定完了',
  supabaseAfterConfig: '✅ 設定完了後、以下が可能に：',
  supabaseSyncDevices: '異なるデバイス間で吸烟記録を同期',
  supabaseCloudBackup: 'データ損失防止のクラウドバックアップ',
