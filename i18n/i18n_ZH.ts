...
export const i18n_ZH = {
  ...
  // ============ Supabase Guide ============
  howToGetSupabaseApi: '如何获取 Supabase API 凭证？',
  supabaseGuideTitle: 'Supabase 配置指南',
  whatIsSupabase: '什么是 Supabase？',
  supabaseDescription: 'Supabase 是一个开源的 Firebase 替代品，提供 PostgreSQL 数据库、身份验证、实时订阅等功能。',
  supabaseUseCase: '使用 Supabase 可以让您的吸烟记录数据在多个设备间同步，并在云端安全备份。',
  supabaseRequirements: '需要准备：',
  supabaseEmail: '一个邮箱地址（用于注册 Supabase 账号）',
  supabaseTime: '约 5-10 分钟时间完成配置',
  supabaseStep1: '步骤 1：注册 Supabase 账号',
  supabaseStep1Desc1: '访问 Supabase 官网：',
  supabaseStep1Desc2: '点击右上角的 "Start your project" 或 "Sign In"',
  supabaseStep1Desc3: '使用 GitHub 账号或邮箱注册/登录',
  supabaseTip: '💡 提示：Supabase 提供免费套餐，足以满足个人使用需求。',
  supabaseStep2: '步骤 2：创建新项目',
  supabaseStep2Desc1: '登录后点击 "New project" 按钮',
  supabaseStep2Desc2: '选择或创建一个组织（Organization）',
  supabaseStep2Desc3: '填写项目信息：',
  supabaseStep2Desc4: 'Name：项目名称（如 popsmoke-tracker）',
  supabaseStep2Desc5: 'Database Password：设置数据库密码（请牢记）',
  supabaseStep2Desc6: 'Region：选择距离您最近的服务器区域',
  supabaseStep2Desc7: '点击 "Create new project" 创建项目',
  supabaseNote: '⏳ 注意：项目创建需要 1-2 分钟，请耐心等待。',
  supabaseStep3: '步骤 3：获取 API 凭证',
  supabaseStep3Desc1: '项目创建完成后，进入项目 Dashboard',
  supabaseStep3Desc2: '点击左侧菜单中的 "Project Settings"（项目设置）',
  supabaseStep3Desc3: '选择 "API" 选项卡',
  supabaseStep3Desc4: '在 "Project API keys" 部分找到以下信息：',
  supabaseProjectUrl: 'Project URL：',
  supabaseAnonKey: 'anon public：',
  supabaseStep4: '步骤 4：配置到本应用',
  supabaseStep4Desc1: '复制 "Project URL" 到本应用的 <strong>SUPABASE_URL</strong> 字段',
  supabaseStep4Desc2: '复制 "anon public" 密钥到本应用的 <strong>SUPABASE_ANON_KEY</strong> 字段',
  supabaseStep4Desc3: '点击保存按钮完成配置',
  supabaseAfterConfig: '✅ 配置完成后，您可以：',
  supabaseSyncDevices: '在不同设备间同步吸烟记录',
  supabaseCloudBackup: '数据云端备份，防止丢失',
